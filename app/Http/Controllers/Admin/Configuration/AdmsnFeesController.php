...
class AdmsnFeesController extends Controller
{
    ...
    {
        return view('admin.configuration.admsnFee.add_new_fee_form');
    }
    ...
    public function searchFees(Request $request)
    {
        ...
        $fees_total = DB::table('admsn_fee_structure')
            ...
            ->where('admsn_fee_structure.class_id',$request->input('class'))
            ->sum('amount');
        return view('admin.configuration.admsnFee.fee_list',compact('fees_search','fees_total') );
    }

    public function admsnFeeEditForm($fee_id)
    {
        try {
        ...
        return view('admin.configuration.admsnFee.admsn_fee_edit_form',compact('fees','class_list'));
    }
