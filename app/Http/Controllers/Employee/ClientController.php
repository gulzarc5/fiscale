...
class ClientController extends Controller
{
    ...
    {
        return view('website.employee.client.client_search');
    }
    ...
    public function ClientEditForm($client_id)
    {
        ...
        return view('website.employee.client.client_edit_form',compact('client','residential','business'));
    }
    ...
    public function clientDetailsNew($client_id)
    {
        ...
        return view('website.employee.client.client_view_new',compact('client','residential','business'));
    }
