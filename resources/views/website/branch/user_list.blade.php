...
<div class="col p-t col-md-10">
   <div class="section-title text-center animated fadeInUp" data-animate="fadeInUp" style="animation-duration: 0.6s; animation-delay: 0.1s;">
      <h1 data-animate="fadeInUp" data-delay=".1s" class="text-uppercase" style="text-shadow: 1px -2px 1px white;">Users <span>List</span></h1>
   </div>
         ...
         <table class="sope--cart-table table pt-sans">
            <tbody>
               ...
               @endphp
                     ...
                     <td>{{$item->mobile}}</td>
                     <td class="view-btn">
                        <a class="btn text-white rounded" href="{{route('branch.user_view',['user_id'=>encrypt($item->id)])}}"><i class="fa fa-eye"></i></a>
                        <a class="btn text-white rounded" href="{{route('branch.client_edit',['client_id'=>encrypt($item->id)])}}"><i class="fa fa-edit"></i></a>
                     </td>
                  </tr>
                     @endforeach
               @else
