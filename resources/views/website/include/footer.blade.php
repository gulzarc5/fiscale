                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 order-last order-lg-first">
                        <div class="copyright text-center text-lg-left">
                            <p class="m-0 pt-sans"><a href="index.html">Fiscaleindia</a> &copy; Copyright 2019. All Rights Reserved.</p>
                        </div>
                    </div>
                    <div class="col-lg-6 order-first order-lg-last">
                        <ul class="accepted-payments pt-sans nav align-items-center justify-content-center justify-content-lg-end">
                            ...
                            <li><a href="https://webinfotech.net.in/" target="_blank">Webinfotech</a></li>
                        </ul>
                    </div>
                </div>
            </div>
