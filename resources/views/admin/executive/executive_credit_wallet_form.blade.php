...
<div class="right_col" role="main">
    <div class="row">
        ...
        <div class="col-md-6" style="margin-top:50px;">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Executive Wallet Credit Form</h2>
                ...
                <div>
                    <div class="x_content">
                        ...
                        {{ Form::open(['method' => 'post','route'=>'admin.executive_credit_wallet']) }}
                            ...
                            <div class="well" style="overflow: auto">
                                <div class="form-row mb-10">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 mb-3">
                                        ...
                                        <input type="number" class="form-control" name="amount" min="1"  value="{{old('amount')}}" placeholder="Enter Wallet Credit Amount" >
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 mb-3">
                                        ...
                                        <textarea type="text" class="form-control" name="comment" placeholder="Type Comment">{{ old('comment')}}</textarea>
