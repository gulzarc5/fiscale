            ...
            <div class="x_panel">
                ...
                <div>
                    @if (isset($employee) && !empty($employee))                        
                        <div class="x_content">
                            {{ Form::open(['method' => 'post','route'=>'admin.change_pass_employee']) }}
                            ...
                            <div class="well" style="overflow: auto">
                                <div class="form-row mb-10">
                                    ...
                                    <div class="col-md-6 col-sm-12 col-xs-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="name"  placeholder="Enter Employee name" value="{{ $employee->name }}" disabled >
                                    </div>
