                        ...
                        <table class="table table-striped jambo_table bulk_action">
                            ...
                            @if (isset($fees) && !empty($fees))
                                ...
                                @foreach ($fees as $item)
                                    ...
                                    <td>
                                        <a href="{{route('admin.promotion_fee_edit_form',['fee_id'=>encrypt($item->id)])}}" class="btn btn-warning">Edit</a>
                                        @if ($item->status == '1')
                                            <a class="btn btn-danger" href="{{route('admin.promotion_fee_status',['id'=>encrypt($item->id),'status'=>encrypt(2)])}}">Disable</a>
                                        @else
                                            <a class="btn btn-success" href="{{route('admin.promotion_fee_status',['id'=>encrypt($item->id),'status'=>encrypt(1)])}}">Enable</a>
                                        @endif
                                    </td>
                                    </tr>                              
                                @endforeach
