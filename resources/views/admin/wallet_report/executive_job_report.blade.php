    ...
    <div class="row">
        <div class="col-md-12" style="margin-top:50px;">
            <div class="x_panel">
                ...
                <div>
                    <div class="x_content">
                        {{ Form::open(['method' => 'post','route'=>'admin.executive_job_report_search']) }}

                         <div class="well" style="overflow: auto">
                            <div class="form-row mb-10">
                                <div class="col-md-6 col-sm-6 col-xs-12 mb-3">
                                    <label for="name">Select Executive</label>
                                    <select class="form-control executive" name="exe_id">
                                      ...
                                      @if($errors->has('exe_id'))
                                          <span class="invalid-feedback" role="alert" style="color:red">
                                              <strong>{{ $errors->first('exe_id') }}</strong>
                                          </span>
                                      @enderror
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12 mb-3">
                                    ...
                                    <select class="form-control" name="search_type" id="search_type">
                                        ...
                                        <option value="1">Executive Jobs</option>
                                        <option value="2">Executive Transactions</option>
                                    </select>
